...
Set the printed `ESCROW_CONTRACT_ADDRESS` and `USDC_CONTRACT_ADDRESS` values in `.env`. The deploy script also mints mock USDC to Anvil account #1 and approves the escrow contract for local agreement funding.
